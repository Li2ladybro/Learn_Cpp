...
//};
//
//template <class K,class V,class KOfT>
//class RBTree
//{
//    // a.根叶黑
//    // b.不红红
...
//    while (cur)
//    {
//        if (koft(cur->data) > koft(data))
//        {
//            parent = cur;
//            cur = cur->_left;
//        }
//
//        else if (koft(cur->data) < koft(data))
//        {
//            parent = cur;
//            cur = cur->_right;
//        }
...
//        cur = new Node(data);
//
//        if (koft(parent->data) > koft(data))
//        {
//            parent->_left = cur;
//            cur->_parent = parent;
//        }
//
//        else if (koft(parent->data) < koft(data))
//        {
//            parent->_right = cur;
//            cur->_parent = parent;
//        }
